...
function App() {
  ...
  return (
   <div className="w-[100vw] h[100vh] flex justify-center items-center bg-black flex-col gap-10">
    <div className="text-[#0398d4] font-medium text-2xl">Increment & decrement</div>
    <div className="bg-white flex justify-center gap-12 py-12 rounded-sm text-[25px] text-[#344151]">
